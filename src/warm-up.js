...
var sequel = title.split(/and/)[0] + "and the Prisoner of Azkaban";
console.log(sequel);
...
if (isFavorite === true) {
  console.log(`My favorite book is ${book1.title}`);
} else {
  console.log(`I recently read the ${sequel}.`);
}
...
var books = [
  ...
  "Harry Potter and the Goblet of Fier",
...
var belowTwoHundred = [1, 2, 6, 4, 6, 7, 7, 9, 100, 112, 14, 18];
